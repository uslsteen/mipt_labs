...
\newline
  ...
  \begin{figure}[h!]
  	\begin{minipage}[h]{0.5\linewidth}
  		\center{\includegraphics[width=0.9\linewidth]{pictures/A_tau.jpg}}
  		\caption{Спектр прямоугольных импульсов при $\tau$=50 мкс}
  		\label{A_tau}
  	\end{minipage}
  	\begin{minipage}[h]{0.5\linewidth}
  		\center{\includegraphics[width=0.9\linewidth]{pictures/A_ff.jpg}}
  ...
  \end{figure}
  	...
  	\begin{figure}[h!]
  		\label{A_graf}
  		\includegraphics[scale=0.47]{lab361_v1.png}
  	...
  	\begin{figure}[h!]
  		\label{B_graf}
  		\includegraphics[scale=0.47]{lab361_2.png}
  ...
  \subsection{Исследование спектра гармонических сигналов, модулированных по амплитуде}
  	...
  	отношения амплитуды боковой линии спектра к амплитуде основной линии $ \left(\frac{A_{main}}{A_{bok}}\right ) $ от глубины модуляции $ m $, которая находится из отношения амплитуд на осциллографе по формуле \eqref{m}.
  	 ...
  	 \begin{figure}[h!]
  	\begin{minipage}[h]{0.5\linewidth}
  		\center{\includegraphics[scale=0.15]{какая-то херня 2.jpg}}
  		\caption{Измерение глубины модуляции, $mx = 0.5 \:  msec$}
  		\label{A_tau}
  	\end{minipage}
  	\begin{minipage}[h]{0.5\linewidth}
  		\center{\includegraphics[scale=0.15]{какая-то херня 1.jpg}}
  		\caption{Измерение глубины модуляции, $mx = 0.5 \:  msec$}
  		\label{A_f}
  	\end{minipage}
  \end{figure}
  	...
  	\begin{figure}[h!]
  		\label{C_g}
  		\includegraphics[scale=0.47]{lab361_v2.png}
